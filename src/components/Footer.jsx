        ...
        <footer className="bg-zinc-900/50 backdrop-blur-sm border-t border-zinc-800/50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    {/* Brand */}
                    <div>
                        <h3 className="text-xl font-bold gradient-text mb-3">&lt;MA /&gt;</h3>
                        ...
                        <div className="flex gap-3">
                            {socialLinks.map((social, index) => (
                                <a
                                    ...
                                    className="p-2 bg-zinc-800/50 text-gray-400 rounded-lg hover:bg-blue-500/10 hover:text-blue-400 hover:border-blue-500/20 border border-zinc-700/50 transition-all duration-300"
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3 text-gray-400 text-sm">
                                ...
                                <a href="mailto:mabdullah13954@gmail@example.com" className="hover:text-blue-400 transition-colors">
